    ...
    return (
      <div>
        <h2 id="reponses-heading">
          <Translate contentKey="backofficeApp.reponses.home.title">Reponses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="backofficeApp.reponses.home.createLabel">Create new Reponses</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {reponsesList && reponsesList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="backofficeApp.reponses.home.notFound">No Reponses found</Translate>
            </div>
          )}
        </div>
      </div>
