    ...
    return (
      <div>
        <h2 id="propositions-heading">
          <Translate contentKey="backofficeApp.propositions.home.title">Propositions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="backofficeApp.propositions.home.createLabel">Create new Propositions</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {propositionsList && propositionsList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="backofficeApp.propositions.home.notFound">No Propositions found</Translate>
            </div>
          )}
        </div>
