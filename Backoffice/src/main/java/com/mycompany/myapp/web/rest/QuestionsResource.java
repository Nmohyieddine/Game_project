...
public class QuestionsResource {
    ...
    public ResponseEntity<List<QuestionsDTO>> getAllQuestions(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
